...
Mathematically, this is achieved by expanding Kohn-Sham molecular orbitals \emph{only} in terms of the atomic orbitals of the same molecules~\cite{stoll,khaliullin2006efficient, blw}.
%RZK: blw - https://doi.org/10.1063/1.481185
%
%RZK: stoll - Stoll, H., Wagenblast, G. & Preuβ, H. Theoret. Chim. Acta (1980) 57: 169. https://doi.org/10.1007/BF00574903
%
%RZK: herbert2016 - 10.1021/acs.jctc.6b00155
...
%RZK: thomas2013computing -- 10.1039/C3CP44302G
...
Finally, a comparison of the stretching bands for the three models shows that the spectacular enhancement of the integrated intensity from the gas to liquid phase is not entirely due to the intermolecular electron transfer as has been usually assumed~(see Chapter 5 in Ref.~\onlinecite{HBbook}). 
...
The change in the derivative is attributed to decoupling of the motion electrons from that of the nuclei in HB systems: stretching of a HB-bonded O--H group causes the electrons (i.e. Wannier centers in Figure~\ref{Fig:acoord}) not to follow the H-atom as much as when O--H does not establish a HB~\cite{HBbook}. 
...
%RZK: Label vertical axis: "Absorbance per molecule". Remove tick labels in y-axis. I assume that vapor intensity is normlized to the same number of molecules.
\end{figure}
...
%RZK: Y-axis label "Relative frequency", remove tick labels "0.0, 0.5, etc."
\end{figure}
...
% RZK: brehm2011travis -- 10.1021/ci200217w
...
% RZK: change two axis labels from "OO" to "OH" in the second panel. Change legend to "Fixed-density devalent" and "Relaxed-density devalent" in all Figures
\end{figure} 
...
% RZK: Change legend to "Fixed-density devalent" and "Relaxed-density devalent". Label vertical axis: "Absorbance per molecule". Remove tick labels in y-axis.
\end{figure} 
