...
%RZK: The quantitative study described here shows that, from the fundamental point of view, this work extends our understanding of [not only the liquid water but of] hydrogen bonding in general. It places reliable order-of-magnitude estimates/limits on the expected changes in various properties if one modifies HB by adjusting the strength of donor-acceptor through various chemical substituents. Implications: shows that ALMO-based AIMD is an excellent tool for the nature of intermolecular bonding in other condensed phase systems. Catalysis, solvation.

%From the practical perspective, %RZK: Impact on water modeling. Small CT explains why it can be neglected [and replaced by simple fine-tuned electrostatic corrections] in all empirical models without noticeable deterioration to their accuracy. Cite: 10.1002/jcc.24426. Our result also suggest that classical models that don't take account of covalency only have limit applicability, as they fine-tune the parameters only for certain conditions.  %RZK: Furthermore, the CT is fairly insensitive to intermolecular rotation of the water molecules, which helps to account for the success of empirical potentials that do not include charge transfer explicitly.
