...
% ZZZ means that we need more citations on: what is known about the strength of local interactions and properties. Properties are not necessarily those mentioned in the list.
