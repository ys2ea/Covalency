...
It is important to clarify that all types of interactions---frozen density, polarization and covalent--- contribute to the distribution of electrons around molecules and, therefore, determine the magnitude of molecular dipoles. The dipoles resulting exclusively from frozen density calculations are typically called permanent dipoles. 
The presence of covalent component dramatically changes configurations with what dipole moments are sampled in the course of simulations. 
...
Although it is difficult to obtain precise values of the dielectric constant in our simulations, this constant is estimated to be several times larger for the devalent than for the reference model (see Supplementary Information). 
...
%
Realistic model              & 0.1069 & 29.5$\times 10^{-4}$ \\
%
Experimental            & 0.239 (Ref.~\cite{hardy2001isotope})  & 8.9 $\times 10^{-4} $ (Ref.~\cite{harris2004temperature})
\end{tabular}
\end{table}
